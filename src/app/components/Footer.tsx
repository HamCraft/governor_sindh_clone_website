            ...
            <div className="footer-links w-full md:w-1/4 mb-5 md:mb-0">
              ...
              <ul className="space-y-2 cursor-pointer">
                ...
                <li className="flex justify-center md:justify-start space-x-3 cursor-pointer">
                  <Image src="/facebook-icon.png" alt="Facebook" width={24} height={24} className="transition duration-300 ease-in-out hover:scale-110 md:w-8 md:h-8" />
                  <Image src="/youtube-icon.png" alt="Youtube" width={24} height={24} className="transition duration-300 ease-in-out hover:scale-110 md:w-10 md:h-10" />
                  <Image src="/instagram-icon.webp" alt="Instagram" width={24} height={24} className="transition duration-300 ease-in-out hover:scale-110 md:w-8 md:h-8" />
                  <Image src="/twitter-icon.png" alt="Twitter" width={24} height={24} className="transition duration-300 ease-in-out hover:scale-110 md:w-8 md:h-8" />
                  <Image src="/tiktok-icon.webp" alt="Tiktok" width={24} height={24} className="transition duration-300 ease-in-out hover:scale-110 md:w-8 md:h-8" />
                </li> 
                {/* Email Line */}
                <li className="flex justify-center md:justify-start items-center space-x-2 mt-3">
                  <Image src="/email-icon.png" alt="Email" width={30} height={24} />
